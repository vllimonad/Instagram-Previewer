...
final class LogInViewModel {
    ...
    func getData(_ code: String){
        NotificationCenter.default.addObserver(forName: Notification.Name.accessTokenWasObtained, object: nil, queue: OperationQueue.main, using: { _ in
    ...
    deinit {
        NotificationCenter.default.removeObserver(self, name: Notification.Name.accessTokenWasObtained, object: nil)
        NotificationCenter.default.removeObserver(self, name: Notification.Name.dataWasObtained, object: nil)
    }
}
